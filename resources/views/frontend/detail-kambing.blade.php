...
@section('content')
    <div class="content-msp">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 ">
                    <img src="{{ $data['kambing']['photo'] != null ? 'https://apps.bukitbiak.com/' . $data['kambing']['photo'][0] : asset('assets/temp_frontend/images/default.png') }}"
                        class="photo-kambing">
                </div>
                <div class="col-lg-6">
                                    ...
                                    <div class="col-md-10">
                                        <div class="number-input md-number-input">
                                            ...
                                            <button onclick="this.parentNode.querySelector('input[type=number]').stepDown()"
                                                class="minus"></button>
                                            <input class="quantity" min="1" name="quantity" value="1" id="quantity"
                                                type="number">
                        ...
                        <div class="box-info-price">
                            ...
                            <div class="box-price">
                                <div class="price-value">
                                    {{ $data['kambing']['harga'] != null ? 'Rp. ' . number_format($data['kambing']['harga'], 0, ',', '.') : 'Rp. 0' }}
                                </div>
                            </div>
                            <div class="box-btn mt-xl-0 ">
                                @if (Auth::user())
                                    ...
                                    <input type="hidden" class="form-control" name="kode" id="kode"
                                        value="{{ $data['kambing']['kode'] }}">
                                    <input type="hidden" class="form-control" name="harga" id="harga"
                                        value="{{ $data['kambing']['harga'] }}">
                                    <input type="hidden" class="form-control" name="jenis" id="jenis"
                                        value="{{ $data['kambing']['jenis'] }}">
                                    <input type="hidden" class="form-control" name="berat" id="berat"
                                        value="{{ $data['kambing']['bobot'] }}">
